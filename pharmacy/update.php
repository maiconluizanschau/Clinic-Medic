...
<div class="">
    ...
    <form class="form-signin" action="" method="POST">
        ...
        <input type="text" id="inputEmail" class="form-control" name="manager_id" placeholder="Your ID" required autofocus> <br/>
        ...
        if(isset($_POST['manager_id']) && isset($_POST['user']) && isset($_POST['pass1']) && isset($_POST['pass2'])) {

            $user = mysql_real_escape_string($_POST['manager_id']);
            $username = mysql_real_escape_string($_POST['user']);
            $pass1 = md5($_POST['pass1']);
            $pass2 = md5($_POST['pass2']);

            $query1 =mysql_query("SELECT * FROM manager WHERE username = '$username'");
            ...
            if(mysql_num_rows($query1) > 0) {
                ...
                $query3 = mysql_query("UPDATE `manager` SET `username` = '$username', `password` = '$pass2' WHERE manager_id = '$user'");
