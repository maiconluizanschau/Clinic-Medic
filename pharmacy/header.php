  ...
  even in small screens. -->
        <div class="mdl-layout mdl-js-layout mdl-layout--fixed-drawer
          ...
          <header class="mdl-layout__header">
            ...
            <span class="mdl-layout-title">Pharmacy</span>
    ...
    <nav class="mdl-navigation">
      <a class="mdl-navigation__link" href="patients.php"> <img scr="../css/img/iaccount_circle_black_241x.png"/>Patients</a>
      <a class="mdl-navigation__link" href="consultations.php">Consultations</a>
      <a class="mdl-navigation__link" href="drugs.php">Drugs</a>
    </nav>
  </div>
