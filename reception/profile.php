...
<script type="text/javascript">
 ...
 <div class="mdl-grid">
	<div class="mdl-cell mdl-cell--5-col">
 		<?php 
 			$profile = mysqli_query($db, "SELECT * FROM receptionist WHERE recep_id = '".$_SESSION['recep_id']."'");
 			if($profile){
 	...
 	<?php 
 		...
 		if(isset($_POST['create'])){
 			...
 			$ins = mysqli_query($db, "UPDATE receptionist SET pass='$pass2' WHERE recep_id = '".$_SESSION['recep_id']."'");
 	...
 	?>
 	<?php 
 	$getpass = mysqli_query($db, "SELECT pass FROM receptionist WHERE recep_id = '".$_SESSION['recep_id']."'");
 	if($getpass){
 	...
 	<?php 
 		...
 		if(isset($_POST['update'])){
 			...
 			$checkpass = mysqli_query($db, "SELECT pass FROM receptionist WHERE recep_id = '".$_SESSION['recep_id']."'");
 			if($checkpass) {
 			...
 			$ins = mysqli_query($db, "UPDATE receptionist SET pass='$newpass2' WHERE recep_id = '".$_SESSION['recep_id']."'");
