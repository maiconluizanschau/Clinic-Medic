...
<form class="form-signin" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>" method="POST" id="ind" style="background: #e0f2f1;">
        <h2 class="form-signin-heading" style="text-align: center;">Sign in <br/> <br/>
           <img src="../css/img/account_circle_black_36dp_2x.png" class="img-circle" alt="Account Circle" align="middle" style="height: 100px;"/>
         </h2>
    ...
    <?php
        ...
        include ("../secure.php");
         ...
         if(isset($_POST['login'])) {
            ...
            $query = mysqli_query ($db, "SELECT * FROM receptionist WHERE username = '$username' AND pass = '$pass'");
 ...
 <label for="inputEmail" class="sr-only">Username</label>
  ...
  <?php
    ...
    if(isset($_POST['create'])){
      ...
      $ins = mysqli_query($db, "UPDATE receptionist SET pass='$pass2' WHERE username = '".$usern."'");
  ...
  <h2 class="form-signin-heading" style="text-align: center;">Reset Password <br/> <br/>
  <label for="inputEmail" class="sr-only">Username</label>
