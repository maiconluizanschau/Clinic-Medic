  ...
  even in small screens. -->
        <div class="mdl-layout mdl-js-layout mdl-layout--fixed-drawer
          ...
          <header class="mdl-layout__header">
            ...
            <span class="mdl-layout-title">Reception</span>
    ...
    <nav class="mdl-navigation">
      <a class="mdl-navigation__link" href="patienthome.php"> <img scr="../css/img/iaccount_circle_black_241x.png"/>Patients</a>
      <a class="mdl-navigation__link" href="schemes.php">Medical Schemes</a>
      <a class="mdl-navigation__link" href="appointment.php">Appointments</a>
      <a class="mdl-navigation__link" href="services.php">Services</a>
      <a class="mdl-navigation__link" href="consultations.php">Consultations</a>
    </nav>
  </div>
