...
<script type="text/javascript">
 ...
 <div class="mdl-grid">
	<div class="mdl-cell mdl-cell--5-col">
 		<?php 
 			$profile = mysqli_query($db, "SELECT * FROM manager WHERE manager_id = '".$_SESSION['manager_id']."'");
 			if($profile){
 	...
 	<?php 
 		...
 		if(isset($_POST['create'])){
 			...
 			$ins = mysqli_query($db, "UPDATE manager SET pass='$pass2' WHERE manager_id = '".$_SESSION['manager_id']."'");
 	...
 	?>
 	<?php 
 	$getpass = mysqli_query($db, "SELECT pass FROM manager WHERE manager_id = '".$_SESSION['manager_id']."'");
 	if($getpass){
 	...
 	<?php 
 		...
 		if(isset($_POST['update'])){
 			...
 			$checkpass = mysqli_query($db, "SELECT pass FROM manager WHERE manager_id = '".$_SESSION['manager_id']."'");
 			if($checkpass) {
 			...
 			$ins = mysqli_query($db, "UPDATE manager SET pass='$newpass2' WHERE manager_id = '".$_SESSION['manager_id']."'");
